...
var hasChanged = function (v1, v2) { return !Object.is(v1, v2); };
...
var cleanupEffect = function (effect) {
    var e_1, _a;
    try {
        for (var _b = __values(effect.deps), _c = _b.next(); !_c.done; _c = _b.next()) {
            var dep = _c.value;
            dep.delete(effect);
        }
    }
...
var emit = function (instance, event) {
    ...
    (_a = props['on' + capitalize(camelize(event))]) === null || _a === void 0 ? void 0 : _a.call.apply(_a, __spreadArray([props], __read(args), false));
};
...
var renderSlot = function (slots, key, props) {
    var _a;
...
var createRenderer = function (options) {
    var createElement = options.createElement, insert = options.insert, patchProp = options.patchProp, createText = options.createText, setElementText = options.setElementText;
     ...
     */
    var patch = function (n1, n2, container, parentComponent) {
        var type = n2.type;
        switch (type) {
            case Fragment: {
    ...
    var processComponent = function (n1, n2, container, parentComponent) {
    ...
    var processElement = function (n1, n2, container, parentComponent) {
        if (!n1) {
    ...
    function processText(n1, n2, container) {
        ...
        var textNode = (n2.el = createText(text));
...
export { computed, createApp, createRenderer, createTextVNode, effect, getCurrentInstance, h, inject, isReactive, isRef, provide, proxyRefs, reactive, readonly, ref, renderSlot, renderer, shallowReadonly };
